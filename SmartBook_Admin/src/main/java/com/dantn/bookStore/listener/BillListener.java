...
public class BillListener {
	...
	public void update(Bill bill) {
		...
		case 2:
			...
			n.setMessage(getMessage(bill.getTranSn(), bill.getStatus().getValue()));
	...
	public String getMessage(String transn,String status) {
		StringBuilder builder=new StringBuilder();
		builder.append("Đơn hàng ");
		builder.append(transn);
		builder.append(" ");

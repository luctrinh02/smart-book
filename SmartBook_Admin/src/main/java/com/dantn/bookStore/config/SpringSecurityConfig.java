...
public class SpringSecurityConfig implements UserDetailsService{
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		// @formatter:off
		http.authorizeHttpRequests(authz -> authz.antMatchers("/admin/smart-book/login","/index/**","/images/**","/login","/admin/smart-book/forgot_password","/smart-book-websocket","/synchronized").permitAll()

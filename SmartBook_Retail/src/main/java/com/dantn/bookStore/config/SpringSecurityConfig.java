...
public class SpringSecurityConfig implements UserDetailsService{
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		// @formatter:off
		http.authorizeHttpRequests(authz -> authz.antMatchers("/","/index/**","/smart-book/home","/api/book/suggest","/smart-book/book","/smart-book","/smart-book/login","/api/book/search","/api/user/**","/smart-book/registry","/api/book/**","/api/type","/api/home").permitAll()
